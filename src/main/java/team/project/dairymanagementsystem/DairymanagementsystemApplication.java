...
public class DairymanagementsystemApplication {
    ...
    CommandLineRunner runner() {
        return (String... args) -> dairyStaffService.addDairyStaff(new DairyStaff("1234", "Admin", "admin@info.co.ke", Gender.MALE, new RoleGroup("admin"), new BCryptPasswordEncoder().encode("12345")));
    }
}
